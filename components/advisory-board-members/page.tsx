...
import { AdvisoryBoardMember } from "@/types/team";


interface AdvisoryMembersCardProps {
    member: AdvisoryBoardMember;
}

function AdvisoryMembersCard({ member }: AdvisoryMembersCardProps) {
...
export default AdvisoryMembersCard