...
import { Bookmark, ChevronRight, Heart, MessageSquare, Send } from "lucide-react";
                ...
                <div className="grid grid-cols-1 py-6">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage className="font-bold text-pink fs-md lg:fs-xl">Blogs Details</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                ...
                <div className="grid grid-cols-12 lg:px-4 gap-6">
                    <div className="col-span-12 xl:col-span-8 space-y-6">
                        <Card className="p-3 lg:p-8">
                            ...
                            <div className="">
                                <ImageSlider images={["/images/blog/blog1.png", "/images/news1.png", "/images/blog/blog2.png"]} className="mb-5" />

                                <div className="flex justify-between  mb-3  flex-col lg:flex-row">
                                    <div className='flex items-center gap-1 py-4'>
                                        ...
                                        <div className="fs-sm md:fs-xl line-height140 text-darkgray flex items-center">
                                            <span className="ml-2 fs-sm md:fs-xl">Eleanor</span>


                                            <span className="ml-2 relative pl-5 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[6px] before:h-[6px] before:bg-[#4A4A4A] before:rounded-full">
                                                26 Nov
                                            </span>
                    ...
                    <div className="col-span-12 xl:col-span-4">
                        ...
                        <div>
                            ...
                            <div className="flex justify-between items-center py-4">
                                <h2 className="font-bold hed-lg ">Popular Blogs</h2>
                                <button className="text-pink fs-md lg:fs-2xl flex gap-2">
                                    See All <ChevronRight />
                                </button>
                            </div>
                            <div className="grid gap-3 grid-cols-1 md:grid-cols-2 xl:grid-cols-1">
                                <NewsCardTypeOne />
                                <NewsCardTypeOne />
                                <NewsCardTypeOne />
                            </div>
